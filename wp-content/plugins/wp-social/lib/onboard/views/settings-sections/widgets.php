...
<div class="wslu-admin-fields-container <?php echo isset($_GET['wp-social-met-onboard-steps']) && sanitize_text_field($_GET['wp-social-met-onboard-steps']) == 'loaded' ? 'wslu-admin-widgets-container' : 'wslu-admin-widget-list'; ?>">
